...
pyenv exec python src/main.py --N 600 --tmax 33 --dt 1e-5 --pin-type drag --D 0.1 --circle --omega-ex '2*600*KAPPA/np.pi/D**2*(1-2*600*KAPPA/np.pi/D**2*t/200/2/np.pi)' --pinning-v-ex "600*KAPPA/D/np.pi/500*$SLURM_ARRAY_TASK_ID" \
